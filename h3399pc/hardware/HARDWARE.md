...
| 项目 | 规格 |
|-----|------|
| **类型** | LPDDR4 @ 856MHz (最高 1056MHz) |
| **容量** | 4GB (4 x 1GB 颗粒) |
| **通道** | 双通道 |
| **芯片丝印** | ZXZY PE0255-125 x 4 |
| **出厂时间** | 2023年上半年批次 |
...
| **频率** | 856MHz (最高 1056MHz) | `opp-856000000` / `opp-1056000000` | 运行频率 / 最高支持频率 |
| **芯片** | ZXZY PE0255-125 x 4 | 实物丝印 | 4 x 1GB 颗粒 |
| **驱动强度** | 60Ω (DQ) | `phy_lpddr4_dq_drv = <0x3c>` | 特殊调优配置 |
| **节点** | /memory, /dmc | `device_type = "memory"` | DMC 动态频率调节 |

> **深度技术解析**: 关于 LPDDR4 初始化、U-Boot 兼容性、DDR 参数配置等详细技术问题，请参考 **[RK3399 U-Boot 与 DDR 初始化技术深度解析](RK3399_UBOOT_DDR_ANALYSIS.md)**
